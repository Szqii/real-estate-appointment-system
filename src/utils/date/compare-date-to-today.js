/**
 * Compare a date string to today and return status and time left
 * @param {string} dateString - Date string to compare
 * @returns {Object} Object with status and left properties
 */
export default function compareDateToToday(dateString) {
  const now = new Date()
