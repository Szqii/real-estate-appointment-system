...
// Child state parent ile eşleşiyor
const selectedContacts = computed({
  get: () => uniqueContacts.filter(c => props.modelValue.includes(c.id)),
  set: (newContacts) => {
    emit("update:modelValue", newContacts.map(c => c.id))
  },
})
