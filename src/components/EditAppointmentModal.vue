<template>
  ...
  >
    <div
      class="relative p-2 sm:p-4 w-full max-w-2xl max-h-[95vh] sm:max-h-[90vh] overflow-y-auto mx-2 sm:mx-4"
    >
      <!-- Modal content -->
        ...
        <form class="p-3 sm:p-4" @submit.prevent="updateAppointment">
          <div class="grid gap-4 mb-4">
            ...
            <div class="col-span-2">
              ...
              <ContactMultiSelect v-model="contactIds" />
            </div>
