  ...
  >
    <div class="relative p-2 sm:p-4 w-full max-w-2xl max-h-[95vh] sm:max-h-[90vh] mx-2 sm:mx-4">
      ...
      <div class="relative bg-white rounded-lg shadow-sm">
        <!-- Modal header -->
        <div
          class="flex items-center justify-between p-3 sm:p-4 border-b rounded-t border-gray-200"
        >
          <h3 class="text-base sm:text-lg font-semibold text-gray-900">Edit Appointment</h3>
          <button
            type="button"
            @click="closeModal"
        ...
        >
          <div class="grid gap-4 mb-4 sm:grid-cols-2">
            <div class="col-span-2">
              ...
              <ContactMultiSelect v-model="contactIds" class="col-span-2" />
            ...
            <div class="col-span-2">
              ...
              >
              <AgentSelect v-model="agentIds" class="col-span-2" />
            ...
            <div class="col-span-2">
              ...
              >
              <DateSelect v-model="appointmentDate" />
...
watch(
  ...
  (newAppointment) => {
    if (newAppointment) {
      ...
      isCancelled.value = newAppointment.isCancelled || false
    }
  },
  { immediate: true },
)
...
const updateAppointment = async () => {
  ...
  try {
    ...
    await store.updateAppointment(props.appointment.id, updateData)
    closeModal()
  } catch (error) {
    // Error toast is already handled in the store
    errors.value.submit = error.message || 'Failed to update appointment. Please try again.'
  } finally {
    loading.value = false
  }
}
